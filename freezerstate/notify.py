...
class Notifier:
    ...
    def send_status_update(self, temperature, current_time):
        ...
        message = f'🌡⏰ {readingLocation} status update. Current temperature is {freezerstate.CONVERSION.TemperatureString(temperature), True}. Uptime: {uptime.total_seconds // 3600} hours.'
